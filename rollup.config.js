...
// External modules.
const external = ['nearley']; // e.g. ['axios'];
const globals = { nearley: 'nearley' }; // e.g { axios: 'axios' };
...
export default [
  // browser-friendly iife build
  {
    ...
    output: [
      {
        banner,
        name: camelCase('model-cpu', { pascalCase: true }), // camelCase(pkg.name, { pascalCase: true }),
        file: pkg.browser,
        format: 'iife',
        esModule: false,
        sourcemap: true,
